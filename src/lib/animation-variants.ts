...
/**
 * Staggered animation for containers with multiple children
...
/**
 * Container variant for fade-up stagger effect
 */
export const fadeUpContainerVariant: Variants = {
  hidden: { opacity: 0 },
  visible: {
    opacity: 1,
    transition: {
...
/**
 * Slide-up container variant with stagger
 */
export const slideUpContainerVariant: Variants = {
  hidden: { opacity: 0 },
  visible: {
    opacity: 1,
    transition: {
