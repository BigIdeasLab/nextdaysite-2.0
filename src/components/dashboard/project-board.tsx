  ...
  return (
    <section className="flex w-full flex-col gap-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-foreground">Production board</h2>
        <span className="text-sm text-foreground/60">Drag & drop coming soon</span>
      </div>
      <div className="grid gap-4 overflow-x-auto pb-2 lg:grid-cols-5">
        {statusColumns.map((column) => {
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                <p className="text-sm font-semibold text-foreground/70">{column.label}</p>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between text-xs text-foreground/60">
                          ...
                          {manager ? <span>Lead {manager.full_name ?? manager.email}</span> : null}
                        </div>
                      </article>
                    );
                  })
