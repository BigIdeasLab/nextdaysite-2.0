...
import { Calendar, DollarSign, User, PenLine, Paperclip, MessageSquare, Share2 } from 'lucide-react'
...
const statusConfig = {
  ...
  ready_to_ship: { label: 'Ready to Ship', color: '#00C3FF', bgColor: '#00303F' },
  ...
  return (
    <div className="project-details-page">
      ...
      <div className="project-breadcrumbs">
        <Link href="/dashboard">Homepage</Link> &gt; <Link href="/dashboard/projects">Project</Link> &gt; Kanban Board &gt; {project.title}
      </div>
      ...
      <div className="project-tabs">
        ...
        <div className="tab-indicator-line">
          <div 
            ...
            style={{ 
              left: activeTab === 'scope' ? '0%' : activeTab === 'deliverables' ? '33.33%' : '66.66%' 
            }}
          />
        </div>
      </div>
            ...
            <div className="scope-section">
              ...
              <div className="technical-specs">
                ...
                <div className="spec-row">
                  ...
                  <span className="spec-value">Strapi (headless integration)</span>
                </div>
                <div className="spec-row">
                ...
                <div className="spec-row">
                  ...
                  <span className="spec-value">Google Analytics 4 + Heatmap tracking</span>
                </div>
              </div>
            </div>
          </div>
