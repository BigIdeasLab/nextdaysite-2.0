...
function PlanTooltip({ active, payload }: { active?: boolean; payload?: any[] }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <PieChart>
        ...
        {total > 0 ? (
          <text x="50%" y="50%" textAnchor="middle" dominantBaseline="middle" fill="var(--foreground)" fontSize={14}>
            {total} total
          </text>
        ) : null}
      </PieChart>
