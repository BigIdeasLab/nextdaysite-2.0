...
const testimonials = [
  {
    id: 1,
    name: "Sarah Chen",
    quote: "NextDaySite delivered our website in 24 hours. The AI-powered design process was incredible!",
  ...
  },
  {
    ...
    quote: "The quality exceeded our expectations. Professional, fast, and exactly what we needed.",
  ...
  },
  {
    id: 4,
    name: "Lisa Chen",
    quote: "A seamless integration of user feedback led to a 30% boost in engagement.",
  ...
  },
  {
    id: 6,
    name: "Sofia Gomez",
    quote: "Innovative features introduced last quarter have driven a 50% increase in subscriptions.",
  ...
  return (
    <section className="relative w-full overflow-hidden rounded-t-[50px] bg-[#131313] px-6 py-16 md:px-12 lg:px-52">
      ...
      <div className="relative mx-auto w-full max-w-5xl">
        <h2 className="mb-16 text-center text-4xl font-medium text-white">Our Outstanding Result</h2>
          ...
          {testimonials.map((testimonial) => (
            ...
            >
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-center text-2xl font-medium text-white">{testimonial.name}</p>
              </div>

              <p className="text-center text-[22px] leading-6" style={{ color: testimonial.textColor }}>
                {testimonial.quote}
              </p>

              <div className="mt-auto flex items-center justify-center">
                <svg width="107" height="27" viewBox="0 0 110 39" fill="none" className="h-7 w-[107px]">
