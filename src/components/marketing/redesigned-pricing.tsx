  ...
  return (
    <section id="pricing" className="w-full px-6 py-16 md:px-12 lg:px-52">
      <div className="mx-auto flex w-full max-w-5xl flex-col items-start gap-24">
        <h2 className="w-full text-center text-4xl font-medium leading-[1.25] text-[#F7F6FF]">Our Pricing plan</h2>
          ...
          {plans.map((plan) => (
            ...
            >
              <div className="flex flex-col gap-8 p-5">
                <div className="flex w-full max-w-[238px] flex-col gap-2">
                  <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 0 25 24" fill="none" className="h-6 w-6">
                      <circle cx="12.5" cy="12" r="5" fill="white" stroke="white" />
                      <path
                  ...
                  <p className="text-base font-light leading-6 text-white/50">{plan.description}</p>
                </div>

                <div className="flex items-center gap-1">
                  <span className="text-[45px] font-medium leading-6 text-white">{plan.price}</span>
                  <span className="text-[21px] font-normal leading-6 text-white/50">{plan.period}</span>
                </div>
                  ...
                  {plan.features.map((feature, index) => (
                    <div key={index} className="flex items-center gap-2.5">
                      <div className="relative h-6 w-6">
                        <svg width="24" height="24" viewBox="0 0 25 24" className="absolute">
                          <circle cx="12.5" cy="12" r="12" fill="#2D2D2D" />
                        </svg>
                        <svg width="20" height="20" viewBox="0 0 21 20" className="absolute left-0.5 top-0.5">
                          <path
                      ...
                      <span className="text-[15px] leading-6 text-white/50">{feature}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="flex items-center justify-center gap-2.5 p-5">
                <svg width="20" height="20" viewBox="0 0 21 20" fill="none" className="h-5 w-5">
                  <path
              ...
              <div className="flex items-center gap-2.5 p-5">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-1">
                    <span className="text-base font-medium text-white">Add Managed Hosting</span>
                    <svg width="17" height="17" viewBox="0 0 18 17" fill="none" className="h-4 w-4">
                      <path
                  ...
                  <span className="text-sm font-light leading-6 text-white/50">Modern 3–5 page website, fast.</span>
                </div>
              </div>
            </div>
          ))}
