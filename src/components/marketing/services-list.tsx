...
const services = [
  {
    ...
    image1: "https://api.builder.io/api/v1/image/assets/TEMP/e9d384835cb0e8f33b19142bcc17d5a053e5db56?width=495",
    image2: "https://api.builder.io/api/v1/image/assets/TEMP/3aea2f8a60b8dac3d8a61a176f3b3bdb4093b3d9?width=495",
    imagePosition: "left",
  },
  {
    id: 2,
    ...
    image1: "https://api.builder.io/api/v1/image/assets/TEMP/1c42014f5095f96c6a60cdc90d347c7138f94834?width=495",
    image2: "https://api.builder.io/api/v1/image/assets/TEMP/4740875d1eb285bc4de30908c7fe6f0edbd07a8d?width=495",
    imagePosition: "right",
  },
  {
    id: 3,
    ...
    image1: "https://api.builder.io/api/v1/image/assets/TEMP/bb107efb32489cb9e751ba74c42c6c8a32a4acaf?width=495",
    image2: "https://api.builder.io/api/v1/image/assets/TEMP/451f47036892e405dcb5fb52187b21deb280867a?width=495",
    imagePosition: "left",
  },
  {
    id: 4,
    ...
    image1: "https://api.builder.io/api/v1/image/assets/TEMP/2d8280d02a56edea3b4086665db656bc92b18bb2?width=495",
    image2: "https://api.builder.io/api/v1/image/assets/TEMP/455e254fb42cfccb9317a5c8fcebbd3238c31aa5?width=495",
    imagePosition: "right",
  },
  {
    id: 5,
    ...
    image1: "https://api.builder.io/api/v1/image/assets/TEMP/49239c52a1518f9f7dd44aa5b823f23bb6c81ec2?width=495",
    image2: "https://api.builder.io/api/v1/image/assets/TEMP/65658e18815e1586d9e6b80e8451346ecdf7a37d?width=495",
    imagePosition: "left",
  },
  {
    id: 6,
    ...
    image1: "https://api.builder.io/api/v1/image/assets/TEMP/e263d588c83097432bb9f9d9f8cd17fc232c70c6?width=442",
    image2: "https://api.builder.io/api/v1/image/assets/TEMP/c031e7e087947b220020396506299ca975d076eb?width=442",
    imagePosition: "right",
  },
];
          ...
          >
            ...
            <div className="flex w-full flex-col items-start gap-10 md:w-1/2">
              <div className="flex flex-col items-start gap-2.5">
                <h3 className="text-3xl font-medium leading-tight text-[#F7F6FF]">{service.title}</h3>
                <p className="text-lg leading-6 text-[#9BA1A6]">{service.description}</p>
              </div>
