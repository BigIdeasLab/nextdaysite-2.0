...
export type ChatMessagesRow = Database["public"]["Tables"]["chat_messages"]["Row"];
...
export const mockUsers: UsersRow[] = [
  {
    ...
    avatar_url: "https://images.unsplash.com/photo-1544723795-3fb6469f5b39?auto=format&fit=facearea&w=256&h=256&q=80",
  ...
  },
  {
    ...
    avatar_url: "https://images.unsplash.com/photo-1502685104226-ee32379fefbe?auto=format&fit=facearea&w=256&h=256&q=80",
  ...
  },
  {
    ...
    role: "collaborator",
    company_name: "NextDaySite Labs",
    avatar_url: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=facearea&w=256&h=256&q=80",
...
export const mockProjects: ProjectsRow[] = [
  {
    ...
    summary: "Building a bold, conversion-focused site for a boutique fitness brand.",
    progress: 58,
    priority: "high",
...
export const mockFiles: FilesRow[] = [
  {
    ...
    description: "Brand system detailing typography, color palette, and guidelines.",
    mime_type: "application/pdf",
    preview_url: "https://files.nextdaysite.com/previews/velocity-style-guide.png",
    size_bytes: 2356789,
    version: 2,
...
export const mockChatMessages: ChatMessagesRow[] = [
  {
    ...
    role: "customer",
    message: "Can we explore a bolder hero headline with a stronger call to action?",
    attachments: null,
